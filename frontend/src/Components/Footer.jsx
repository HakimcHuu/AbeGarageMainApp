              ...
              <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
                <div className="info-inner">
                  <div className="content">
                    ...
                    <div className="text">
                      Madda Walabu University, <br /> Bale Goba, Oromia Region,
                      Ethiopia,
                    </div>
                  </div>
                </div>
              ...
              <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
                <div className="info-inner">
                  <div className="content">
                    ...
                    <div className="text">
                      Email us : <br />{" "}
                      <a href="mailto:contact.degefagomora@gmail.com">
                        degefagomora@gmail.com
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="footer-column col-lg-4">
                  <div className="widget widget_newsletter">
                    ...
                    <ul className="social-links">
                      ...
                      <li>
                        <a href="https://www.linkedin.com/in/degefa-gomora-4ba34530b/">
        ...
        <div className="auto-container">
          <div className="footer-bottom">
            <div className="copyright-text">
              © Copyright <a href="#">Abe-Garage</a> 2025 . All right reserved.
            </div>
            <div className="text">
              Created by <a href="#">Degefa Gomora</a>
            </div>
          </div>
        </div>
      </footer>
